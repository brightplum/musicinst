				    		...
				    		<div class="main-content-wrapper">
		    	    			...
		    	    			<div class="listings-wrapper">
									...
									<div class="class-finder-results">
										...
										<?php if(count($class_listings) > 0): ?>
											
											<?php $i = 1; ?>
											
											<?php foreach($class_listings as $listing): ?>
											
												<div class="item <?php echo $i == count($class_listings) ? 'last' : ''; ?>">
													<?php echo $listing; ?>
												</div>
										...
										<?php else: ?>
											...
											<p><em>There are no classes that match your criteria.</em></p>

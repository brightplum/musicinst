				    	...
				    	<div class="middle-column">						    						    	
				    		...
				    		<div class="main-content-wrapper">
								...
								<?php if(count($course['classes']) > 0): ?>
									...
									<table cellspacing="1">
										<tr>
											<th width="20%" class="bold-font">Day</th>
											<th width="20%" class="bold-font">Time</th>
											<th width="20%" class="bold-font">Start Date</th>
											<th width="20%" class="bold-font">Location</th>
											<th width="20%" class="bold-font">Instructor</th>
										</tr>
